...
export default function AuthPage() {
  ...
  // simple nav handlers — swap with your router if you have one
  ...
  const handleSubmit = (e) => {
    ...
    setMessage(
      tab === "login"
        ? `Welcome back, ${payload.email || "friend"}!`
        : `Account created for ${payload.email || "you"} ✔`
    );
  };
  ...
  return (
    <div className="app auth-page">
      <PfNav
  theme={theme}
  onToggleTheme={toggle}          // ⬅️ was toggleTheme (undefined)
          ...
          <div className="auth-grid">
            ...
            <Reveal className="auth-card card" variant="fade-left" delay={60}>
              ...
              <form key={tab} onSubmit={handleSubmit} className="form" noValidate>
                <label htmlFor="email" className="fade-item" style={{animationDelay:"40ms"}}>Email or phone number</label>
                <input id="email" name="email" type="email" placeholder="you@company.com" required className="fade-item" style={{animationDelay:"80ms"}}/>
                ...
                {/* {message && (
                  <p className="toast fade-item" style={{animationDelay:"440ms"}} role="status" aria-live="polite">
                    {message}
                  </p>
                )} */}
              </form>
